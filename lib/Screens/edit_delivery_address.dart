...
class EditDeliveryAddressPage extends StatefulWidget {
  ...
  EditDeliveryAddressPage({@required this.addressModel});

  @override
  _EditDeliveryAddresspagePageState createState() =>
      _EditDeliveryAddresspagePageState();
}

class _EditDeliveryAddresspagePageState extends State<EditDeliveryAddressPage> {
  String other;
  String state;
  String userId;
  String primary;
  ...
  void initState() {
    ...
    setasPrimaryAdrz = addressModel.primary;
    _loadUserId();
